...
def acona_success_metrics_etl():
    ...
    def transform(metrics: dict):
        ...
        for key in matomo:
          ...
          for key in datatables:
            matomo_data.extend{variable: {"url": url, "value": values[key], "date": date}}
    ...
    def load(metrics: dict):
        ...
        for key in matomo_data:
          #data = {"url": "https://www.acolono.com", "value": "10", "date": "2021-09-19"}
          table = key
